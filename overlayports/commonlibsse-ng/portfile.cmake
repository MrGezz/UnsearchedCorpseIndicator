vcpkg_from_github(
        ...
        HEAD_REF main
        # See commonlibsse-ng-b93280e-1.7.x-address-library-format5.patch for why.
        # Without it this port cannot run on Skyrim 1.7.x at all.
        PATCHES
            commonlibsse-ng-b93280e-1.7.x-address-library-format5.patch
)
